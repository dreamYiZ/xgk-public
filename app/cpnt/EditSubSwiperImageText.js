    ...
    <Box my={2}>
      ...
      >
        ...
        <Box sx={{}} hidden={tabIndex !== 1} >
          <TextField value={faceWidth} onChange={(event) => setFaceWidth(event.target.value)} type="number" label="图片宽度" variant="outlined" />
          <Box mt={1}></Box>

          <TextField value={commentFontSize} onChange={(event) => setCommentFontSize(event.target.value)} type="number" label="图片高度" variant="outlined" />
          <Box mt={1}></Box>

          <ColorField label="颜色" value={color} onChange={(event) => setColor(event)} />
          <Box mt={1}></Box>

          <TextField value={nameFontSize} onChange={(event) => setNameFontSize(event.target.value)} type="number" label="行高" variant="outlined" />
          <Box mt={1}></Box>

          <TextField value={descFontSize} onChange={(event) => setDescFontSize(event.target.value)} type="number" label="文字宽度" variant="outlined" />
          <Box mt={1}></Box>

          <TextField value={commentTime} onChange={(event) => setCommentTime(event.target.value)} type="number" label="文字间距" variant="outlined" />
          <Box mt={1}></Box>
          <Box mt={1}></Box>

          <TextField value={slidesPerView} onChange={(event) => setSlidesPerView(event.target.value)} type="number" label="宽度" variant="outlined" />
          <Box mt={1}></Box>

          <TextField value={slidesPerView} onChange={(event) => setSlidesPerView(event.target.value)} type="number" label="高度" variant="outlined" />
          <Box mt={1}></Box>
